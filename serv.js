            ...
            db.serialize(() => {
                ...
                db.all(`SELECT * FROM TakeHistory WHERE return = '-'`, (err, rows) => {
                    ...
                    while (i <= rows.length) {
                        ...
                        console.log(parseInt(qwhen[0]),d1.getDate(),parseInt(qwhen[1]),d1.getMonth()+1,parseInt(qwhen[2]),d1.getFullYear(),!(parseInt(qwhen[0]) <= d1.getDate() && parseInt(qwhen[1]) <= d1.getMonth()+1 && parseInt(qwhen[2]) <= d1.getFullYear()))
